...
Route::group(['middleware'=>'throttle:15,1'],function(){
    ...
    Route::get('/alumni-administration', [HomeController::class, 'alumniAdministration'])->name('alumniAdministration');
    Route::get('/alumni-association', [HomeController::class, 'alumniAssociation'])->name('alumniAssociation');
    ...
    Route::get('/academic-calendar', [HomeController::class, 'academicCalendar'])->name('academicCalendar');
    Route::get('/sports-calendar', [HomeController::class, 'sportsCalendar'])->name('sportsCalendar');
    Route::get('/essential-forms', [HomeController::class, 'essentialForms'])->name('essentialForms');
