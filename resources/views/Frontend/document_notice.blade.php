                                    ...
                                    <div class="panel-heading">
                                        <div class="row">
                                            <div class="col col-sm-5 col-xs-12">
                                                <h4 class="title">Notice/ <span>Notification</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($notices as $notice)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="user_icon">
                                                                                <a href="{{ $notice->filename }}"><img style="height:50px;width:50px;" src="{{ asset('Frontend/images/links-icon.jpeg') }}"
                                                                                    alt=""></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="user_icon">
                                                                                <a href="{{ asset('upload/Notice') }}/{{ $notice->filename }}"><img style="height:50px;width:50px;" src="{{ asset('Frontend/images/pdf.png') }}"
                                                                                    alt=""></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
