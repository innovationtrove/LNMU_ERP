                    ...
                    <div class="slickslider-item item clearfix active">
                        ...
                        <div class="item-content">
                            <div class="item-content-inner">
                                <h5 class="item-title" >
                                    <a href="#" style="color:#7C0000" title="" >Home</a> | <a href="#" style="color:#7C0000" title="" >Raj Library</a>
                                </h3>
                            </div>
                        </div>
...
<p class="text-center">Raj Library</p>
</div>
<!-- slider ends here -->

    <section class="container" style="margin-top: 50px;margin-bottom:50px;">
        <h3 class="text-center">Data will be uploaded soon...</h3>
    </section>
