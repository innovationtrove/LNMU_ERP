                            ...
                            <div class="slickslider-items bg-style1">
                                ...
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/15 aug20.jpg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                ...
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli2.jpg') }}"
                                            style="height:350px ;" /></div>
                                </div>

                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli3.jpg') }}"
                                            style="height:350px ;" /></div>
                                </div>

                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli4.jpg') }}"
                                            style="height:350px ;" /></div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli5.jpeg') }}"
                                            style="height:350px ;" /></div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli6.jpg') }}"
                                            style="height:350px ;" /></div>
                                </div>

                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow"><img alt=""
                                            src="{{ asset('Frontend/images/banners/jubli7.jpeg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/jubli8.jpg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/jubli9.jpg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/jubli10.jpeg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/jubli11.jpeg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                                <div class="slickslider-item item clearfix">
                                    <div class="images-slideshow">
                                        <img alt="" src="{{ asset('Frontend/images/banners/jubli12.jpg') }}"
                                            style="height:350px ;" />
                                    </div>
                                </div>
                            ...
                            <div class="modcontent clearfix">
                                <div id="category_16297137721453353795" class="sj_category theme4">
                                    <ul class="line items-row1">
                                        ...
                                        <li class="" style="width: -20px;">
                                            <a href="https://grievance.lnmu.ac.in/" target="_blank"><img
                ...
                <div class="row">
                    <div id="top3" class="col-sm-12">
                        <div class="marquee" id="mycrawler" style="width:100%;">
                            ...
                            <!--<a href="{{ asset('upload/Notice/26-Jul-20224767.pdf') }}" target="_blank"><i-->
                            <!--        class="fa fa-envelope">-->
                            <!--    </i> Notification of Examination Forms and Fee of M.Ed <img-->
                            <!--        src="{{ asset('Frontend/images/newanim.gif') }}" /></a>-->

                            <!--<a href="{{ asset('upload/Notice/26-Jul-20222946.pdf') }}" target="_blank"><i-->
                            <!--        class="fa fa-envelope">-->
                            <!--    </i> Notification of Examination forms and Fee of Six Month Certificate <img-->
                            <!--        src="{{ asset('Frontend/images/newanim.gif') }}" /></a>-->
                ...
                <div class="row">
                    ...
                    <div id="top9" class="col-lg-3 col-sm-6  slideLft1">
                        <ul>
                            ...
                            <li><a href="{{ route('academicCalendar') }}" target="_blank">Academic Calendar</a></li>
                                                ...
                                                <div class="meganew-items theme1">
                                                    <div class="item-other">
                                                        ...
                                                        <!--    </li>-->
                                                            ...
                                                            <!--        class="col-xs-12" title=""-->
                                                            <!--        target="_blank"><i-->
                                                            <!--            class="fa fa-envelope"></i>Result of B.Lib. and-->
                                                            <!--        Inf. Sc. (Session : 2021-22) Examination - 2022 <img-->
                                                            <!--            src="{{ asset('Frontend/images/newanim.gif') }}" />-->
                                                            <!--    </a>-->
                                                            <!--</li>-->
                                                        </ul>
