                ...
                <div class="row">
                    <div class="col-md-4">
                        <ul style="font-size: 15px;">
                          <li> <a href="{{asset('upload/iqac/composition/Reconstitution of IQAC_09.02.2022.pdf')}}" target="_blank">IQAC_Reconstitution_09/02/2022</a></li>
                          <li> <a href="{{asset('upload/iqac/composition/Reconstitution of IQAC_21.09.2021.pdf')}}" target="_blank">IQAC_Reconstitution_2020-21</a></li>
                        </ul>
                      </div>
                </div>
