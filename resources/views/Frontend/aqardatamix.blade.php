                    ...
                    <div class="slickslider-item item clearfix active">
                        ...
                        <div class="item-content">
                            <div class="item-content-inner">
                                <h5 class="item-title" >
                                    <a href="#" style="color:#7C0000" title="" >Home</a> | <a href="#" style="color:#7C0000" title="" >AQAR Data</a>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <ul>
                                            <li><a href="{{asset('upload/aqardata/AQAR 2019-2020.pdf')}}">AQAR 2019-20</a></li>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        <ul>
                                            <li><a href="{{asset('upload/aqardata/AQAR 2018-2019.pdf')}}">AQAR 2018-19</a></li>
