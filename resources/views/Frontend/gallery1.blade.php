...
@section('content')
    ...
    <div class="container-fluid"
        ...
        <p class="text-center">Golden Jubilee Gallery</p>
    </div>
    <!-- slider ends here -->
    ...
    <div class="container demo-gallery">
        <ul id="lightgallery" class="list-unstyled row">
            ...
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli1.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli2.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli3.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli4.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli5.jpeg') }}" style="height:150px;">
            </a>
        </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Fading Light</h4><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli6.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli7.jpeg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli8.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli9.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli10.jpeg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli11.jpeg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/golden-jubilee/jubli12.jpg') }}" style="height:150px;">
                </a>
            </li>
        </ul>
    </div>
