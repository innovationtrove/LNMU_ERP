...
@section('content')
    ...
    <div class="container-fluid"
        ...
        <p class="text-center">Photo Gallery Alumni Association</p>
    </div>
    <!-- slider ends here -->
    ...
    <div class="container demo-gallery">
        <ul id="lightgallery" class="list-unstyled row">
            ...
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/05.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/06.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/07.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/08.jpg') }}" style="height:150px;">
            </a>
        </li>
        <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
            ...
            data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
            <a href="">
                <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/09.jpg') }}" style="height:150px;">
            </a>
        </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Fading Light</h4><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/10.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/11.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/12.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/13.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/14.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/15.jpg') }}" style="height:150px;">
                </a>
            </li>
            <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/16.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/17.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/18.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/19.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/20.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/21.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/22.jpg 480, Frontend/images/college/c7.jpg 800"
                data-src="Frontend/images/college/c7.jpg"
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/23.jpg') }}" style="height:150px;">
                </a>
            </li>
             <li class="col-xs-6 col-sm-4 col-md-3" style="border: 3px dotted gold;border-radius:5px;box-shadow:0px 0px 15px 10px grey;"
                data-responsive="Frontend/images/college/c7.jpg 375, Frontend/images/college/c7.jpg 480, Frontend/images/college/c7.jpg 800"
                ...
                data-sub-html="<h4>Bowness Bay</h4><p>A beautiful Sunrise this morning taken En-route to Keswick not one as planned but I'm extremely happy I was passing the right place at the right time....</p>">
                <a href="">
                    <img class="img-responsive" src="{{ asset('upload/gallery/alumni-pics/24.jpg') }}" style="height:150px;">
                </a>
            </li>
        </ul>
    </div>
