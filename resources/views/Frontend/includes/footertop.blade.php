            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="module  useful-link">
                        ...
                        <div class="modcontent clearfix">
                            <ul class="menu">
                                ...
                                <li class="item-1539"><a href="{{ route('about.campus') }}">The Campus</a></li>
                ...
                <div id="bottom3" class="col-md-3 col-sm-6">
                    <div class="module  useful-link">
                        ...
                        <div class="modcontent clearfix">
                            <ul class="menu">
                                <li class="item-1537"><a href="https://www.aiu.ac.in/">AIU Meetings Notifications</a></li>
                                <li class="item-1538"><a href="https://ugc.ac.in/">UGC Notification</a></li>
